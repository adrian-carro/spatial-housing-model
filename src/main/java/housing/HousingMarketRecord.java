...
public abstract class HousingMarketRecord implements Serializable {
     ...
     * particular, this class implements the comparators for a price-quality priority queue.
     */
    public static class PFSaleComparator implements PriorityQueue2D.XYComparator<HousingMarketRecord>, Serializable {
        private static final long serialVersionUID = 6225466622291609603L;

        /**
         * @return -1 or 1 if arg0 is, respectively, cheaper than or more expensive than arg1 solving the arg0 == arg1
         * case by reverse comparing their FSale and comparing their Id's if they also have the same FSale
         */
        @Override
        public int XYCompare(HousingMarketRecord arg0, HousingMarketRecord arg1) {
            double diff = arg0.price - arg1.price;
            if (diff == 0.0) {
                diff = ((RegionQualityRecord) arg1).getFSale() - ((RegionQualityRecord) arg0).getFSale(); // Note the reverse ordering here
                if (diff == 0.0) {
                    diff = arg0.getId() - arg1.getId();
                }
            }
        ...
        /**
         * @return -1, 0 or 1 if arg0 has, respectively, less FSale than, equal FSale as, or greater FSale than
         * arg1
         */
        @Override
        public int YCompare(HousingMarketRecord arg0, HousingMarketRecord arg1) {
            return Integer.signum((int) (((RegionQualityRecord) arg0).getFSale() - ((RegionQualityRecord) arg1).getFSale()));
        }
    } 
   
    /**
     * Class that implements the comparators needed for inserting HousingMarketRecord objects into PriorityQueue2D. In
     * particular, this class implements the comparators for a price-FRent priority queue.
     */
    public static class PFRentComparator implements PriorityQueue2D.XYComparator<HousingMarketRecord>, Serializable {
        private static final long serialVersionUID = 6225466622291609603L;

        /**
         * @return -1 or 1 if arg0 is, respectively, cheaper than or more expensive than arg1 solving the arg0 == arg1
         * case by reverse comparing their FRent and comparing their Id's if they also have the same FRent
         */
        @Override
        public int XYCompare(HousingMarketRecord arg0, HousingMarketRecord arg1) {
            double diff = arg0.price - arg1.price;
            if (diff == 0.0) {
                diff = ((RegionQualityRecord) arg1).getFRent() - ((RegionQualityRecord) arg0).getFRent(); // Note the reverse ordering here
                if (diff == 0.0) {
                    diff = arg0.getId() - arg1.getId();
                }
            }
        ...
        /**
         * @return -1, 0 or 1 if arg0 has, respectively, less FRent than, equal FRent as, or greater FRent than
         * arg1
         */
        @Override
        public int YCompare(HousingMarketRecord arg0, HousingMarketRecord arg1) {
            return Integer.signum((int) (((RegionQualityRecord) arg0).getFRent() - ((RegionQualityRecord) arg1).getFRent()));
        }
    } 
